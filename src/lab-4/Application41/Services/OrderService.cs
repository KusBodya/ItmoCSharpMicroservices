...
public class OrderService : IOrderService
{
    ...
    public async Task<Order> CreateOrderAsync(string createdBy, CancellationToken cancellationToken = default)
    {
        ...
        await _orderCreationProducer.PublishOrderCreatedAsync(order.OrderId, now, cancellationToken);
        return order;
    }
    ...
    public Task CancelDuringProcessingAsync(long orderId, CancellationToken cancellationToken = default)
    {
        return ChangeOrderStateAsync(
            orderId,
            OrderState.Cancelled,
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            await _orderCreationProducer.PublishOrderProcessingStartedAsync(orderId, now, cancellationToken);
        }
    }
