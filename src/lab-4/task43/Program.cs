...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        builder.Services.Configure<OrderProcessingServiceOptions>(
        ...
        builder.Services.AddSingleton<IProcessingClient, OrderProcessingClient>();
